# Generated by Django 4.1.7 on 2023-09-28 23:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choiceid', models.ForeignKey(blank=True, db_column='choiceid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='appGCISL.choice')),
                ('questionid', models.ForeignKey(blank=True, db_column='questionid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='appGCISL.question')),
                ('surveyid', models.ForeignKey(blank=True, db_column='surveyid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='appGCISL.survey')),
            ],
            options={
                'db_table': 'response',
                'managed': True,
        ...
        migrations.AddField(
            model_name='question',
            name='surveyid',
            field=models.ForeignKey(blank=True, db_column='surveyid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='appGCISL.survey'),
        ),
        migrations.AddField(
            model_name='choice',
            name='questionid',
            field=models.ForeignKey(blank=True, db_column='questionid', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='appGCISL.question'),
        ),
        migrations.CreateModel(
            name='GCISLUser',
            fields=[
